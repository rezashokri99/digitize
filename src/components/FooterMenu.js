...
const FooterMenu = () => {
    ...
    return (
        <ul className="flex items-center justify-between">
          ...
          <li onClick={(e) => openTabHandler(e, 1)} className="flex-auto py-3 " ><a href="#" className={`${isOpenTab === 1 ? "text-slate-800" : "text-gray-400"} dark:text-stone-100 flex items-center justify-center text-base`}>
            <span>
          ...
          <li onClick={(e) => openTabHandler(e, 2)} className="flex-auto py-3" ><a href="#" className={`${isOpenTab === 2 ? "text-slate-800" : "text-gray-400"} dark:text-stone-100 flex items-center justify-center text-base`}>
            <span>
          ...
          <li onClick={(e) => openTabHandler(e, 3)} className="flex-auto py-3" ><a href="#" className={`${isOpenTab === 3 ? "text-slate-800" : "text-gray-400"} dark:text-stone-100 flex items-center justify-center text-base`}>
            <span>
              <svg width="34" height="34" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <li onClick={(e) => openTabHandler(e, 4)} className="flex-auto py-3" ><a href="#" className={`${isOpenTab === 4 ? "text-slate-800" : "text-gray-400"} dark:text-stone-100 flex items-center justify-center text-base`}>
            <span>
