...
const SingleProduct = () => {
  ...
  return (
    <>
      {/* breadcrumb desktop */}
      <div className="bg-white hidden md:block md:col-span-9 lg:col-span-10 rounded-md"></div>
      ...
      <div className="md:bg-white col-span-12 md:col-span-9 lg:col-span-10">
        ...
        {/* breadcrumb mobile */}
        <div className="flex items-end gap-x-1.5 text-xs mb-10 pr-6px">
        ...
        <div>
          {/* product image */}
          <div className="mb-8">
            <img className="mx-auto" src={iphone13_128} alt="iphone13" />
          </div>
          ...
          {/* seller info mobile */}
          <div className="flex items-center flex-wrap gap-y-2 w-80 mx-auto mb-7">
          ...
          {/* product attributes */}
          <div className="bg-white xs:w-[430px] sm:w-[500px] mx-auto flex flex-col p-5 rounded-xl text-slate-800 mb-3">
            ...
            <ul className="flex flex-col text-lg list-disc gap-y-2 marker:bg-orange-500 list-inside">
              <li className="flex flex-col">
                ...
                <span className="font-medium">128 گیگابایت</span>
              </li>

              <li className="flex flex-col">
                <span className="font-light">بازه ی اندازه صفحه نمایش:</span>
                <span className="font-medium">6 اینچ و بزرگتر</span>
              </li>
          ...
          {/* product Review */}
          <div className="bg-white w-full xs:w-[430px] sm:w-[500px] flex flex-col p-5 rounded-xl mx-auto text-slate-800 mb-3">
            
            <h3 className="mb-5 text-xl font-bold ">نقد و بررسی این محصول</h3>
            <p className={`mb-4 ${openReviewSection ? "h-full text-clip overflow-visible" : "text-ellipsis overflow-hidden h-72"  }`}>
            ...
            <p onClick={() => setOpenReviewSection(prev => !prev)} className="text-orange-500 font-medium text-left">
            ...
            <div className="bg-white xs:w-[430px] sm:w-[500px] mx-auto flex flex-col py-3 px-5 rounded-xl text-slate-800">
                
                <div className="bg-stone-100  w-72 justify-center py-1 flex rounded-3xl overflow-hidden mb-8 mx-auto">
      ...
      {/* btn add to cart */}
      <div className="bg-white w-full fixed bottom-0 left-0 rounded-tr-md rounded-tl-md z-20">
