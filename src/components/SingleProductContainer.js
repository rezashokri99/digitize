    ...
    <>
      ...
      <div className="bg-white dark:bg-slate-700 hidden md:flex items-center md:col-span-9 lg:col-span-10 rounded-md">
        <div className="flex items-end gap-x-1.5 text-base pr-6px">
          <span className="text-orange-500">{product.type}</span>
          ...
          <span className="text-gray-600 dark:text-stone-100 text-sm h-[21px]">{product.persianName}</span>
        </div>
      </div>
      ...
      <div className="md:bg-white  dark:bg-slate-700 col-span-12 md:col-span-9 lg:col-span-10">
        ...
        <div className="flex md:hidden  items-end gap-x-1.5 text-xs mb-10 pr-6px">
          ...
          <span className="text-gray-600 dark:text-stone-100">{product.persianName}</span>
        </div>
            ...
            <div className="md:hidden  flex items-center flex-wrap gap-y-2 w-80 mx-auto mb-7">
              <div className="flex gap-x-2 items-center ml-2">
                <div className="flex gap-x-1">
                  ...
                  <span className="font-bold text-sm text-slate-800 dark:text-stone-300 ">
                    فروشنده:
                  </span>
                </div>
                <span className="text-xs text-slate-800 dark:text-stone-300">دیجی تایز</span>
              </div>
              ...
              <div className="flex gap-x-2 items-center">
                ...
                <span className="text-xs text-slate-800 dark:text-stone-300">18 ماه زرین خدمت</span>
              </div>
              ...
              <div className="flex gap-x-2 items-center w-full justify-center">
                ...
                <span className="text-xs text-slate-800 dark:text-stone-300">انبار تهرن</span>
              </div>
            </div>
          </div>
